    ...
    () => (
      <>
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-1"
            name="prep"
          ...
          <TypedTrans
            ...
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-1"
        ...
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-2"
            name="prep"
          ...
          <TypedTrans
            ...
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-2"
                  className="hover:cursor-pointer"
                />
              ),
              ProofOfIdentity: <TechnicalTerm name="proofOfIdentity" />,
        ...
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-3"
            name="prep"
          ...
          <TypedTrans
            ...
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-3"
                  className="hover:cursor-pointer"
                />
              ),
        ...
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-4"
            name="prep"
          ...
          <TypedTrans
            ...
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-4"
                  className="hover:cursor-pointer"
                />
              ),
  ...
  const VendorIssuerPurchaserPreparerInstructions = useCallback(
    () => (
      <>
          ...
          <TypedTrans
            ...
            components={{
              ...
              DeedOfSaleImportantLink: (
                <ImportantLink
                  href="/doc-gen/vehicle/deed-of-purchase"
                  target="_blank"
              ...
              GovtDeedOfSaleLink: (
                <Link
                  href="https://nlta.govmu.org/Documents/Downloads/Download%20Forms/deed-purchase.pdf"
                  target="_blank"
        ...
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-5"
            name="prep"
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByVendor.preparedByPurchaser.step5"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-5"
                  className="hover:cursor-pointer"
                />
              ),
              PDFAbbr: <Abbr name="pdf" />,
  ...
  const PurchaserIssuerPurchaserPreparerInstructions = useCallback(
    () => (
      <>
        ...
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-6"
            name="prep"
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByPurchaser.preparedByPurchaser.step6"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-6"
                  className="hover:cursor-pointer"
                />
              ),
              PDFAbbr: <Abbr name="pdf" />,
        ...
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-7"
            name="prep"
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByPurchaser.preparedByPurchaser.step7"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-7"
                  className="hover:cursor-pointer"
                />
              ),
              PDFAbbr: <Abbr name="pdf" />,
    ...
    () => (
      <>
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByVendorAndPurchaser.preparedByPurchaser.step5"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
    ...
    () => (
      <>
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByVendorDelegate.preparedByPurchaser.step5"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
    ...
    () => (
      <>
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByPurchaserDelegate.preparedByPurchaser.step6"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByPurchaserDelegate.preparedByPurchaser.step7"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
        ...
        <div className="flex gap-2">
          <Checkbox
            id="purchase-prep-conditional-step-8"
            name="prep"
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2i-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByPurchaserDelegate.preparedByPurchaser.step8"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
              label: (
                <label
                  htmlFor="purchase-prep-conditional-step-8"
                  className="hover:cursor-pointer"
                />
              ),
              PDFAbbr: <Abbr name="pdf" />,
  ...
  return (
    <div className="my-2 flex flex-col gap-3">
      <div className="grid grid-cols-[auto_1fr] grid-rows-[auto_auto] gap-2">
        ...
        <FormSelect
          name="numOfVendors"
          label={tSecondHandVehicleI2IPurchaseInstructions(
        ...
        <FormSelect
          ...
          containerClassName="col-start-2 mt-1 leading-4"
        >
      ...
      <div className="grid grid-cols-[auto_1fr] grid-rows-[auto_auto] gap-2">
        ...
        <TypedTrans
          ...
          components={{
            label: (
              <label
                htmlFor="purchase-payment-last-step"
                className="hover:cursor-pointer"
              />
            ),
          }}
