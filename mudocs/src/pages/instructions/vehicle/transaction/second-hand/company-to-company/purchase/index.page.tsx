...
export default function C2CPurchaseInstructions() {
  ...
  const documentTitle = generateDocumentTitle(
    tSecondHandVehicleC2CPurchaseInstructions("documentTitle"),
  );
  ...
  return (
    <>
      ...
      <h1 className={styles.h1}>
        {tSecondHandVehicleC2CPurchaseInstructions("pageTitle")}
      </h1>

      <div className="one-col-text my-[4rem]">
        <Formik initialValues={initialValues} onSubmit={noop}>
          <form>
            <p>{tSecondHandVehicleC2CPurchaseInstructions("description")}</p>
