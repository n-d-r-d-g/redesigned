      ...
      <>
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1.requirement1"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1.requirement2"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1.requirement3"
              params={{
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1.requirement4"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1.requirement5"
              components={{
                label: (
                  <label
          ...
          {directorProofIsRequired && (
            <div className="flex gap-2">
              ...
              <TypedTrans
                ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
                i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1.directorProofRequirement"
                params={{
                  numOfCompany1Directors: values.numOfCompany1Directors,
      ...
      <>
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1AndCompany2.requirement1"
              components={{
                label: (
                  <label
                    htmlFor="sale-administrative-status-certificate-conditional-1-requirement-1"
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1AndCompany2.requirement2"
              components={{
                label: (
                  <label
                    htmlFor="sale-administrative-status-certificate-conditional-1-requirement-2"
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1AndCompany2.requirement3"
              params={{
                numOfCompany1Directors: values.numOfCompany1Directors,
              }}
              components={{
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1AndCompany2.requirement4"
              components={{
                label: (
                  <label
                    htmlFor="sale-administrative-status-certificate-conditional-1-requirement-4"
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1AndCompany2.requirement5"
              components={{
                label: (
                  <label
                    htmlFor="sale-administrative-status-certificate-conditional-1-requirement-5"
          ...
          {directorProofIsRequired && (
            <div className="flex gap-2">
              ...
              <TypedTrans
                ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
                i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1AndCompany2.directorProofRequirement"
                params={{
                  numOfCompany1Directors: values.numOfCompany1Directors,
                  whetherDirectorIsRequired,
                }}
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany1AndCompany2.requirement6"
              components={{
                label: (
                  <label
    ...
    () => (
      <>
        ...
        <ul>
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1.item1"
            components={{
              DeedsOfSale: <TechnicalTerm name="deedOfSale" count={2} />,
            }}
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1.item2"
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1.item3"
            params={{
              numOfCompany1Directors: values.numOfCompany1Directors,
            }}
            components={{
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1.item4"
            components={{
              VehicleRegistrationBook: (
                <TechnicalTerm name="vehicleRegistrationBook" />
              ),
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1.item5"
            components={{
          ...
          {directorProofIsRequired && (
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1.directorProofItem"
              params={{
                numOfCompany1Directors: values.numOfCompany1Directors,
                whetherDirectorIsRequired,
              }}
    ...
    () => (
      <>
        ...
        <ul>
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1AndCompany2.item1"
            components={{
              DeedsOfSale: <TechnicalTerm name="deedOfSale" count={2} />,
            }}
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1AndCompany2.item2"
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1AndCompany2.item3"
            params={{
              numOfCompany1Directors: values.numOfCompany1Directors,
            }}
            components={{
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1AndCompany2.item4"
            components={{
              VehicleRegistrationBook: (
                <TechnicalTerm name="vehicleRegistrationBook" />
              ),
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1AndCompany2.item5"
            components={{
              AdministrativeStatusCertificate: (
                <TechnicalTerm name="administrativeStatusCertificate" />
              ),
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1AndCompany2.item6"
            components={{
              AdministrativeStatusCertificate: (
                <TechnicalTerm name="administrativeStatusCertificate" />
              ),
          ...
          {directorProofIsRequired && (
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany1AndCompany2.directorProofItem"
              params={{
                numOfCompany1Directors: values.numOfCompany1Directors,
                whetherDirectorIsRequired,
              }}
  ...
  const Company1Instructions = useCallback(
    () => (
      <>
        <TypedTrans
          ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
          i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.description"
          components={{
            p: <p className="mt-4" />,
            DeedOfSale: <TechnicalTerm name="deedOfSale" count={1} />,
          }}
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.step1"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.step2"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.step3"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.step4"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.step5"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.step6"
              params={{
                numOfCompany1Directors: values.numOfCompany1Directors,
              }}
              components={{
          ...
          {directorProofIsRequired && (
            <div className="flex gap-2">
              ...
              <TypedTrans
                ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
                i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1.directorProofStep"
                params={{
                  numOfCompany1Directors: values.numOfCompany1Directors,
                  whetherDirectorIsRequired,
                }}
    ...
    () => (
      <div className="mb-3 mt-2 flex flex-col gap-3">
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1AndCompany2.step1"
            components={{
              label: (
                <label
                  htmlFor="sale-administrative-status-certificate-conditional-3-step-1"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1AndCompany2.step2"
            components={{
              label: (
                <label
                  htmlFor="sale-administrative-status-certificate-conditional-3-step-2"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1AndCompany2.step3"
            components={{
              label: (
                <label
                  htmlFor="sale-administrative-status-certificate-conditional-3-step-3"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1AndCompany2.step4"
            components={{
              label: (
                <label
                  htmlFor="sale-administrative-status-certificate-conditional-3-step-4"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1AndCompany2.step5"
            components={{
              label: (
                <label
                  htmlFor="sale-administrative-status-certificate-conditional-3-step-5"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1AndCompany2.step6"
            params={{
              numOfCompany1Directors: values.numOfCompany1Directors,
            }}
            components={{
        ...
        {directorProofIsRequired && (
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2c-sale-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions3.issuedByCompany1AndCompany2.directorProofStep"
              params={{
                numOfCompany1Directors: values.numOfCompany1Directors,
                whetherDirectorIsRequired,
              }}
