      ...
      <>
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          ...
          {directorProofIsRequired && (
            <div className="flex gap-2">
              <Checkbox
                id="purchase-administrative-status-certificate-conditional-1-director-proof-requirement"
                name="administrative-status-certificate"
              ...
              <TypedTrans
                ...
                components={{
                  label: (
                    <label
                      htmlFor="purchase-administrative-status-certificate-conditional-1-director-proof-requirement"
                      className="hover:cursor-pointer"
                    />
                  ),
                }}
    ...
    () => (
      <div className="mb-3 mt-2 flex flex-col gap-3">
        ...
        {directorProofIsRequired && (
          <div className="flex gap-2">
            <Checkbox
              id="purchase-administrative-status-certificate-conditional-3-director-proof-step"
              name="administrative-status-certificate"
            ...
            <TypedTrans
              ...
              components={{
                label: (
                  <label
                    htmlFor="purchase-administrative-status-certificate-conditional-3-director-proof-step"
                    className="hover:cursor-pointer"
                  />
                ),
              }}
