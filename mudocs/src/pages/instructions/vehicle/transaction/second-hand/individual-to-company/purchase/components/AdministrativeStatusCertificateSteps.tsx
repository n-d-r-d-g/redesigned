      ...
      <>
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-i2c-purchase-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany.requirement5"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-i2c-purchase-page"
              i18nKey="administrativeStatusCertificate.conditionalInstructions1.issuedByCompany.requirement6"
              components={{
                label: (
                  <label
  ...
  const CompanyInstructions = useCallback(
    () => (
      <>
        <TypedTrans
          ns="instructions-vehicle-transaction-2nd-hand-i2c-purchase-page"
          i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany.description"
          components={{
            p: <p className="mt-4" />,
            NLTAAbbr: <Abbr name="nlta" />,
          }}
        ...
        <ul>
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2c-purchase-page"
            i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByCompany.item7"
            components={{
              AdministrativeStatusCertificate: (
                <TechnicalTerm name="administrativeStatusCertificate" />
              ),
  ...
  const VendorAndCompanyInstructions = useCallback(
    () => (
      <>
        <TypedTrans
          ns="instructions-vehicle-transaction-2nd-hand-i2c-purchase-page"
          i18nKey="administrativeStatusCertificate.conditionalInstructions2.issuedByVendorAndCompany.description"
          params={{ numOfVendors: values.numOfVendors }}
          components={{
            p: <p className="mt-4" />,
            NLTAAbbr: <Abbr name="nlta" />,
