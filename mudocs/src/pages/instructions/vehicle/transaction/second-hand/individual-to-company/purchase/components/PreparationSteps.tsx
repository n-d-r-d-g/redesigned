  ...
  return (
    ...
    >
      ...
      <option value="vendorAndCompany">
        {tCommon("administrativeStatusCertificateIssuers.vendorAndCompany", {
    ...
    () => (
      <>
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2c-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByVendor.preparedByCompany.step5"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
    ...
    () => (
      <>
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-i2c-purchase-page"
            i18nKey="preparation.conditionalInstructions.issuedByVendorAndCompany.preparedByCompany.step5"
            params={{
              numOfVendors: values.numOfVendors,
            }}
            components={{
  ...
  return (
    <div className="my-2 flex flex-col gap-3">
      <div className="grid grid-cols-[auto_1fr] grid-rows-[auto_auto] gap-2">
        ...
        <FormSelect
          name="numOfVendors"
          label={tSecondHandVehicleI2CPurchaseInstructions(
