...
export default function I2CSaleInstructions() {
  ...
  const documentTitle = generateDocumentTitle(
    tSecondHandVehicleI2CSaleInstructions("documentTitle"),
  );
  ...
  return (
    <>
      ...
      <h1 className={styles.h1}>
        {tSecondHandVehicleI2CSaleInstructions("pageTitle")}
      </h1>
      <div className="one-col-text my-[4rem]">
        <Formik initialValues={initialValues} onSubmit={noop}>
          <form>
            <p>{tSecondHandVehicleI2CSaleInstructions("description")}</p>
