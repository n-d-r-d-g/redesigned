      ...
      <>
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByPurchaser.requirement1"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByPurchaser.requirement2"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByPurchaser.requirement3"
              params={{
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByPurchaser.requirement4"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByPurchaser.requirement5"
              components={{
                label: (
                  <label
      ...
      <>
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByCompanyAndPurchaser.requirement1"
              components={{
                label: (
                  <label
                    htmlFor="purchase-non-attachment-conditional-1-requirement-1"
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByCompanyAndPurchaser.requirement2"
              components={{
                label: (
                  <label
                    htmlFor="purchase-non-attachment-conditional-1-requirement-2"
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByCompanyAndPurchaser.requirement3"
              params={{
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByCompanyAndPurchaser.requirement4"
              components={{
                label: (
                  <label
                    htmlFor="purchase-non-attachment-conditional-1-requirement-4"
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByCompanyAndPurchaser.requirement5"
              components={{
                label: (
                  <label
                    htmlFor="purchase-non-attachment-conditional-1-requirement-5"
          ...
          {directorProofIsRequired && (
            <div className="flex gap-2">
              <Checkbox
                id="purchase-non-attachment-conditional-1-director-proof-requirement"
                name="non-attachment"
              ...
              <TypedTrans
                ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
                i18nKey="nonAttachment.conditionalInstructions1.issuedByCompanyAndPurchaser.directorProofRequirement"
                params={{
                  numOfDirectors: values.numOfDirectors,
                ...
                components={{
                  label: (
                    <label
                      htmlFor="purchase-non-attachment-conditional-1-director-proof-requirement"
                      className="hover:cursor-pointer"
                    />
                  ),
                }}
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions1.issuedByCompanyAndPurchaser.requirement6"
              components={{
                label: (
                  <label
    ...
    () => (
      <>
        ...
        <ul>
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByPurchaser.item1"
            components={{
              DeedsOfSale: <TechnicalTerm name="deedOfSale" count={2} />,
            }}
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByPurchaser.item2"
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByPurchaser.item3"
            params={{
              numOfPurchasers: values.numOfPurchasers,
            }}
            components={{
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByPurchaser.item4"
            components={{
              VehicleRegistrationBook: (
                <TechnicalTerm name="vehicleRegistrationBook" />
              ),
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByPurchaser.item5"
            components={{
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByPurchaser.item6"
            components={{
              NonAttachmentCertificate: (
                <TechnicalTerm name="nonAttachmentCertificate" />
              ),
    ...
    () => (
      <>
        ...
        <ul>
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByCompanyAndPurchaser.item1"
            components={{
              DeedsOfSale: <TechnicalTerm name="deedOfSale" count={2} />,
            }}
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByCompanyAndPurchaser.item2"
          />
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByCompanyAndPurchaser.item3"
            params={{
              numOfDirectors: values.numOfDirectors,
              whetherDirectorIsRequired,
            }}
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByCompanyAndPurchaser.item4"
            components={{
              VehicleRegistrationBook: (
                <TechnicalTerm name="vehicleRegistrationBook" />
              ),
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByCompanyAndPurchaser.item5"
            components={{
              NonAttachmentCertificate: (
                <TechnicalTerm name="nonAttachmentCertificate" />
              ),
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions2.issuedByCompanyAndPurchaser.item6"
            components={{
              NonAttachmentCertificate: (
                <TechnicalTerm name="nonAttachmentCertificate" />
              ),
          ...
          {directorProofIsRequired && (
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions2.issuedByCompanyAndPurchaser.directorProofItem"
              params={{
                numOfDirectors: values.numOfDirectors,
                whetherDirectorIsRequired,
              }}
  ...
  const CompanyInstructions = useCallback(
    () => (
      <>
        <TypedTrans
          ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
          i18nKey="nonAttachment.conditionalInstructions3.issuedByCompany.description"
          components={{
            p: <p className="mt-4" />,
            DeedOfSale: <TechnicalTerm name="deedOfSale" count={1} />,
          }}
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions3.issuedByCompany.step2"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions3.issuedByCompany.step3"
              components={{
                label: (
                  <label
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions3.issuedByCompany.step4"
              components={{
                label: (
                  <label
    ...
    () => (
      <div className="mb-3 mt-4 flex flex-col gap-3">
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions3.issuedByCompanyAndPurchaser.step1"
            components={{
              label: (
                <label
                  htmlFor="purchase-non-attachment-conditional-3-step-1"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions3.issuedByCompanyAndPurchaser.step2"
            components={{
              label: (
                <label
                  htmlFor="purchase-non-attachment-conditional-3-step-2"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions3.issuedByCompanyAndPurchaser.step3"
            components={{
              label: (
                <label
                  htmlFor="purchase-non-attachment-conditional-3-step-3"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions3.issuedByCompanyAndPurchaser.step4"
            components={{
              label: (
                <label
                  htmlFor="purchase-non-attachment-conditional-3-step-4"
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions3.issuedByCompanyAndPurchaser.step5"
            params={{
              numOfDirectors: values.numOfDirectors,
            }}
            components={{
        ...
        <div className="flex gap-2">
          ...
          <TypedTrans
            ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
            i18nKey="nonAttachment.conditionalInstructions3.issuedByCompanyAndPurchaser.step6"
            components={{
              label: (
                <label
        ...
        {directorProofIsRequired && (
          <div className="flex gap-2">
            <Checkbox
              id="purchase-non-attachment-conditional-3-director-proof-step"
              name="non-attachment"
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-purchase-page"
              i18nKey="nonAttachment.conditionalInstructions3.issuedByCompanyAndPurchaser.directorProofStep"
              params={{
                numOfDirectors: values.numOfDirectors,
                whetherDirectorIsRequired,
              }}
              components={{
                label: (
                  <label
                    htmlFor="purchase-non-attachment-conditional-3-director-proof-step"
                    className="hover:cursor-pointer"
                  />
                ),
              }}
