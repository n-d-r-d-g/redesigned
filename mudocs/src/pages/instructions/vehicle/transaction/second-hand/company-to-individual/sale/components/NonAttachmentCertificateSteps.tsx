        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          ...
          {directorProofIsRequired && (
            <div className="flex gap-2">
              ...
              <TypedTrans
                ns="instructions-vehicle-transaction-2nd-hand-c2i-sale-page"
                i18nKey="nonAttachment.conditionalInstructions1.issuedByCompany.directorProofRequirement"
                params={{
                  numOfDirectors: values.numOfDirectors,
      ...
      <>
        ...
        <ul>
          ...
          {directorProofIsRequired && (
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-sale-page"
              i18nKey="nonAttachment.conditionalInstructions2.issuedByCompany.directorProofItem"
              params={{
                numOfDirectors: values.numOfDirectors,
                whetherDirectorIsRequired,
              }}
      ...
      <>
        ...
        <div className="mb-3 mt-2 flex flex-col gap-3">
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-sale-page"
              i18nKey="nonAttachment.conditionalInstructions3.issuedByCompany.step5"
              params={{
                numOfDirectors: values.numOfDirectors,
              }}
              components={{
          ...
          <div className="flex gap-2">
            ...
            <TypedTrans
              ns="instructions-vehicle-transaction-2nd-hand-c2i-sale-page"
              i18nKey="nonAttachment.conditionalInstructions3.issuedByCompany.step6"
              components={{
                label: (
                  <label
          ...
          {directorProofIsRequired && (
            <div className="flex gap-2">
              ...
              <TypedTrans
                ns="instructions-vehicle-transaction-2nd-hand-c2i-sale-page"
                i18nKey="nonAttachment.conditionalInstructions3.issuedByCompany.directorProofStep"
                params={{
                  numOfDirectors: values.numOfDirectors,
                  whetherDirectorIsRequired,
                }}
