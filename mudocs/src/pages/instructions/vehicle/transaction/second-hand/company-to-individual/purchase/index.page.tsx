...
export default function C2IPurchaseInstructions() {
  ...
  const documentTitle = generateDocumentTitle(
    tSecondHandVehicleC2IPurchaseInstructions("documentTitle"),
  );
  ...
  return (
    <>
      ...
      <h1 className={styles.h1}>
        {tSecondHandVehicleC2IPurchaseInstructions("pageTitle")}
      </h1>

      <div className="one-col-text my-[4rem]">
        <Formik initialValues={initialValues} onSubmit={noop}>
          <form>
            <p>{tSecondHandVehicleC2IPurchaseInstructions("description")}</p>
