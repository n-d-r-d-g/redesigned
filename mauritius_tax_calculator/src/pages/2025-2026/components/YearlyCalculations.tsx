  ...
  return (
    <Accordion selectionMode="multiple" variant="splitted" className="px-0">
      ...
      <AccordionItem
        ...
        subtitle={tCurrentYear("year.output.fsc.subtitle")}
        classNames={{
          heading: "m-0 py-2",
          content: "pb-4",
          indicator: "text-2xl text-default-700 rotate-[-180deg]",
      ...
      >
        <Table
          aria-label={tCurrentYear("year.output.fsc.table.title")}
          shadow="none"
        >
          <TableHeader>
            <TableColumn className="uppercase">
              {tCurrentYear("year.output.fsc.table.headers.description")}
            </TableColumn>
            <TableColumn align="end" className="w-36 uppercase">
              {tCurrentYear("year.output.fsc.table.headers.amount")}
            </TableColumn>
          </TableHeader>
          <TableBody>
            <TableRow key="fsc">
              <TableCell>
                <span className="font-bold">
                  {tCurrentYear("year.output.fsc.table.description.fsc")}
                </span>{" "}
                (*
                {tCurrentYear(
                  "year.output.fsc.table.description.chargeableIncome"
                )}
                {" x "}
        ...
        <p className="text-sm">
          *
          {tCurrentYear("year.output.fsc.fscChargeableIncomeExplanation", {
        ...
        >
          ...
          <TableBody>
            ...
            <TableRow key="fsc">
              <TableCell>
                {tCurrentYear(
                  "year.output.incomeAfterTaxes.table.description.fsc"
                )}
              </TableCell>
              <TableCell className="text-end">
                {decimalToString(fsc, 2)}
